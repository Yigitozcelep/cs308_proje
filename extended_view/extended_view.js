/*document.addEventListener('DOMContentLoaded', function () {
   ...
   //table navigation 
    ...
    prevButton.addEventListener('click', function() {
        const currentIndex = tableOrder.indexOf(tableType.textContent.trim());
        const prevIndex = (currentIndex - 1 + tableOrder.length) % tableOrder.length;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function showTable(tableName) {
        ...
        document.getElementById('table-type').textContent = tableName;
        updateButtons(tableName);
    }
    ...
    function updateButtons(currentTable) {
        ...
        document.getElementById('prev-button').textContent = `< ${tableOrder[prevIndex]}`;
        document.getElementById('next-button').textContent = `${tableOrder[nextIndex]} >`;
    }

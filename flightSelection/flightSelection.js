...
document.querySelector('form').addEventListener('submit', function(event) {
    ...
    if (selectedOption === 'flightNo') 
    {
        ...
        window.location.href = `flightList/flightlist.html?searchType=${selectedOption}&flightNo=${flightNo}`;
    ...
    else if (selectedOption === 'route') 
    {
        ...
        window.location.href = `flightList/flightlist.html?searchType=${selectedOption}&departure=${departure}&arrival=${arrival}&depDate=${depDate}`;
    ...
    else if (selectedOption === 'airportAndDate')
    {
        ...
        window.location.href = `flightList/flightlist.html?searchType=${selectedOption}&airport=${airport}&depDate2=${depDate2}`;
    }
